...
const NPC_QUOTES = {
  chloe: [
    '길드장 님! 오늘도 모험가 지원서가 들어왔어요. 함께 검토해 볼까요?',
    '길드가 점점 유명해지고 있어요. 함께 노력해봐요!',
    '대기실을 증축하면 모험가 분들을 더 데리고 올 수 있답니다.',
    '기한이 만료된 지원서는 제가 반납해둘게요! 아쉽지만 더 좋은 만남을 위해서라면야...',
    '전사, 마법사, 치유사 조합은 국가에서 공인한 최고의 조합이에요!',
    '한때는 저도 지원서를 넣던 시기가 있었답니다. 모험은 힘들지만, 즐겁죠!',
    '저는 모험단의 짐꾼으로 일해왔어요. 힘은 자신 있지만, 싸움은 영... 헤헤...',
    '길드장 님, 길드의 재정에는 여유가 있나요? 과소비는 좋지 않아요!',
    '길드가 성장하면 재건을 계획하셔도 좋아요. 모아왔던 골드에 따라 여러 혜택이 있답니다!',
    '정산품을 운반하는 건 제게 맡겨주세요! 동전 한닢도 남김없이 챙겨올게요!',
    '모험가 분들께 제공할 장비는 공방에서 제작할 수 있어요!',
  ],
  sion: [
    '어서오세요~ 황금의 길 최고의 상품들을 준비했답니다! 마음에 드는 게 있으면 주저 말고 말씀해 주세요.',
    '이 상품들은 제가 직접 발품 팔아서 모은 거예요. 가격은... 조금만 더 깎아드릴까요? 아, 안 돼요. 원가가...',
    '한정 판매 상품은 1시간마다 바뀌어요. 마음에 드는 게 있으면 바로 사세요!',
    '부스트 스크롤은 제가 직접 만든 거예요. 효과는 보장합니다~',
    '황금의 길 학파에서는 마법보다 장사를 더 잘 가르쳐줬어요.',
    '길드장 님, 투자는 곧 성장이에요. 쓸 때 쓰셔야죠!',
    '솔에서 태어나서 좋은 점? 세상 어디서든 환영받는 거죠~',
    '다른 길드에서도 거래 제안이 오긴 하는데... 여기가 제일 편해요.',
  ],
  aida: [
    '안녕하십니까, 길드장 님. 공방 가동이 필요하신가요?',
    '공방의 사고율은 제가 부임한 이후 단 한 번도 0%를 벗어난 적이 없습니다.',
    '제작에는 정확한 절차가 필요합니다. 서두르시면 안 됩니다.',
    '재료 합성도 공방에서 가능합니다. 시간이 다소 소요되오니 양해 바랍니다.',
    '질서의 대성당에서 배운 것은 하나, 절차를 준수하라. 그게 전부입니다.',
    '장비 제작 시 슬롯과 재료를 신중히 선택해 주십시오.',
    '경험치 서 제작은 모험가 양성에 효과적입니다. 적극 권장 드립니다.',
    '에테리아에서 온 제가 베른에 정착한 이유요? ...업무 환경이 마음에 들었습니다.',
  ],
  tiamat: [
    '아직도 여기 있느냐. 뭘 꾸물거리는 것이냐.',
    '미지의 영역 탐사는 잘 되고 있는 것이겠지?',
    '이 몸이 허가를 내린 이상, 반드시 결과를 가져와야 할 것이다.',
    '네 길드의 성장을 인정하마. 그러나 아직 갈 길이 멀다.',
    '서리 산맥 위에서 모든 것을 내려다보는 기분이 어떤지 아느냐? ...뭐, 네녀석은 모르겠지.',
    '드래곤의 정찰대가 세 번이나 돌아오지 않았다. 그곳이 어떤 곳인지... 너도 곧 알게 될 것이다.',
    '용왕의 검을 쥔 자가 있다고? ...흥, 그것은 선대의 유물일 뿐이다.',
    '네녀석들이 이 몸의 영토를 밟았을 때, 솔직히 기대하지 않았다. 하지만... 인정은 해주마.',
    '경지 따위로 만족하느냐? 진정한 힘은 그 너머에 있다.',
    '이 몸을 실망시키지 마라. 그것만은... 용서하지 않겠다.',
  ],
};
  ...
  const tiamatNpcHtml = State.tiamatMet ? `
    <div id="prestige-tiamat-npc" style="display:flex;align-items:center;gap:14px;margin-bottom:20px">
      ...
      <div id="tiamat-npc-bubble" style="background:white;border:2px solid var(--gold-dark);border-radius:12px;padding:12px 16px;position:relative;font-size:0.88rem;line-height:1.5;color:#3e2200;box-shadow:var(--shadow);flex:0 1 auto;cursor:pointer"
        onclick="this.querySelector('p').textContent = pickNpcQuote('tiamat')">
